...
project = 'AntiNex Network Pipeline'
...
htmlhelp_basename = 'AntiNexNetworkPipelinedoc'
...
texinfo_documents = [
    (master_doc,
     'AntiNexNetworkPipeline',
     'AntiNex Network Pipeline Documentation',
     author, 'AntiNexNetworkPipeline', 'One line description of project.',
     'Miscellaneous'),
]
